...
public class DSListView<T> extends RelativeLayout implements AbsListView.OnScrollListener {
    ...
    private int advancedNotClosing = 2;
    ...
    private void hideListView() {
        if (!readyToHide || animationInProgress || scrollInProgress || !listViewIsShown || adapter == null || advancedNotClosing == 1) return;

        advancedNotClosing = 2;
        readyToHide = false;
